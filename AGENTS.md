...
## Current Priorities
1. Live-проверка Этапов 4–10 (телепорт-блок, данжи, динамические руды,
   предгенерация, WorldEdit, конфиг, мобы и атмосфера).
2. Этап 11 — полировка и CI (скрыть нижний бедрок).
