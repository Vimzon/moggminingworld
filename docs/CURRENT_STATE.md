...
Updated: 2026-08-14
Версия: 0.4.0-stage10 | Minecraft 1.20.1 | Forge 47.2.0 | Java 17

## Current Task
**Этап 10 — мобы и атмосфера** реализован (ванильные мобы в биоме, дроп
руд с мобов через GLM, туман глубины, нет дневного цикла). Следующий по
плану — **Этап 11: полировка и CI** (скрыть нижний бедрок). Сначала —
live-проверка Этапов 4–10.
...
7. Этап 11 — скрыть нижний бедрок (слой камня над ним + рваный край).

## How to Verify (Этапы 4–10)
...
14. В логе сервера при генерации первых чанков будет `[Mogg] Failed to scan
...
- НЕ начинать Этап 11 до live-проверки Этапов 4–10.
